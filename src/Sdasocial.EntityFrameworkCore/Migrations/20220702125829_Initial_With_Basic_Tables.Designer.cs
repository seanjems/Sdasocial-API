...
{
    [DbContext(typeof(SdasocialDbContext))]
    [Migration("20220702125829_Initial_With_Basic_Tables")]
    partial class Initial_With_Basic_Tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sdasocial.Follower.Follower", b =>
                {
            ...
            modelBuilder.Entity("Sdasocial.Like.Like", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sdasocial.Posts.Posts", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sdasocial.Users.User", b =>
                {
            ...
            modelBuilder.Entity("Sdasocial.Follower.Follower", b =>
                {
                    b.HasOne("Sdasocial.Users.User", null)
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("Sdasocial.Like.Like", b =>
                {
                    b.HasOne("Sdasocial.Posts.Posts", null)
                        .WithMany("Likes")
